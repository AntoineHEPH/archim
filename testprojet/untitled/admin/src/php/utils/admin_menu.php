<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="index_.php?page=accueiladmin.php">Archimaide</a>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="index_.php?page=visualiser_horaire.php">Horaire</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="index_.php?page=creation_horaire_complet.php">Créer un horaire</a></li>
                </ul>
            </li>
        </ul>
